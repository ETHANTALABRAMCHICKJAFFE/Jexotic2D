...
//				GameObject secondGameObject = (GameObject) secondCollider.getParent();
...
//				Vector2d secondGameObjectVelocity = secondGameObject.getVelocity();
				...
				GameObject rectangleGameObject1 = null,rectangleGameObject2 = null,circleGameObject1 = null,circleGameObject2 = null;
				if(circleGameObjects.size() == 1 && rectGameObjects.size() == 1){
					...
					Vector2d cornerHit = Collider.detectCornerCollision(circleGameObject1.collider, rectangleGameObject1.collider);
					...
					if (cornerHit != null) {
						if (!circleGameObject1.getIsDestroyed() && !rectangleGameObject1.getIsDestroyed()) {
							...
							if(GameManager.realisticCollisions){
						    	...
						    	double newVelX1 = (circleGameObject1.velocity.getX() * (circleGameObject1.mass - rectangleGameObject1.mass) + (2 * rectangleGameObject1.mass * rectangleGameObject1.velocity.getX())) / (circleGameObject1.mass + rectangleGameObject1.mass);
						    	double newVelY1 = (circleGameObject1.velocity.getY() * (circleGameObject1.mass - rectangleGameObject1.mass) + (2 * rectangleGameObject1.mass * rectangleGameObject1.velocity.getY())) / (circleGameObject1.mass + rectangleGameObject1.mass);
						    	double newVelX2 = (rectangleGameObject1.velocity.getX() * (rectangleGameObject1.mass - circleGameObject1.mass) + (2 * circleGameObject1.mass * circleGameObject1.velocity.getX())) / (circleGameObject1.mass + rectangleGameObject1.mass);
						    	double newVelY2 = (rectangleGameObject1.velocity.getY() * (rectangleGameObject1.mass - circleGameObject1.mass) + (2 * circleGameObject1.mass * circleGameObject1.velocity.getY())) / (circleGameObject1.mass + rectangleGameObject1.mass);
						    	//circleGameObject1.setVelocity(new Vector2d(newVelX1,newVelY1));
						    	double normalizedCircleVelDirection = (new Vector2d(newVelX1,newVelY1)).length();
						    	//normalizedCircleVelDirection = normalizedCircleVelDirection.normalized();
						    	Vector2d newVel = Vector2d.mul(normalizedCircleVelDirection,cornerHit.normalized());
						    	//newVel = Vector2d.mul(normalizedCircleVelDirection,newVel.normalized());
							...
							if(circleGameObject1.isMovable)
							 circleGameObject1.setVelocity(Vector2d.mul(circleGameObject1.getVelocity().length(),cornerHit.normalized()));
					...
					if (hit != null) {
						...
						if (!circleGameObject1.getIsDestroyed() && !rectangleGameObject1.getIsDestroyed()) {
							...
							if(GameManager.realisticCollisions){
						    	...
						    	double normalizedCircleVelDirection = (new Vector2d(newVelX1,newVelY1)).length();
						    	//normalizedCircleVelDirection = normalizedCircleVelDirection.normalized();
						    	Vector2d reflectedVel = circleGameObject1.getVelocity().reflect(Vector2d.getNormalOfVector(hit));
							...
							rectangleGameObject1.setVelocity(circleGameObject1.getVelocity());
							if(circleGameObject1.isMovable)
							circleGameObject1.setVelocity(circleGameObject1.getVelocity().reflect(Vector2d.getNormalOfVector(hit)));
							circleGameObject1.onCollision(rectangleGameObject1.collider,circleGameObject1);
							 rectangleGameObject1.onCollision(circleGameObject1.collider,rectangleGameObject1);
							}else{
							 circleGameObject1.onTrigger(rectangleGameObject1.collider,circleGameObject1);
					...
					if (!Collider.areCirclesGoingToCollide(((Circle) circleGameObject1.getCollider().getColliderShape()),(Circle) circleGameObject2.getCollider().getColliderShape(),Vector2d.sub(circleGameObject1.velocity, circleGameObject2.velocity))) {
						return;
					}
//					System.out.println("<first>"+circleGameObject1+"</first><second>"+circleGameObject2+"</second>");
					if(!circleGameObject1.isTrigger() && !circleGameObject2.isTrigger()){
						 Collider.calculateCollisionOfTwoCircles(circleGameObject1.collider,
								 circleGameObject2.collider);
